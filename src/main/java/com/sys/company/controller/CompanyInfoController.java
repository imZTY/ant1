package com.sys.company.controller;
...
public class CompanyInfoController {
    ...
    /**
     * @api {post} /sys/company/update 修改公司信息
     * @apiGroup CompanyInfo
    ...
    /**
     * @api {post} /sys/company/delete 删除公司
     * @apiGroup CompanyInfo
     * @apiParam {int} id 公司id
     * @apiSuccessExample Success-Request:
     * {
    ...
    /**
     * @api {get} /sys/company/list 按页获取公司列表
     * @apiGroup CompanyInfo
