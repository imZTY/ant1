 ...
 */
@RestController
@RequestMapping("/product/sort/type")
public class ProductTypeController {
    ...
    /**
     * @api {post} /product/sort/type/add 新增子分类
    ...
    /**
     * @api {post} /product/sort/type/update 修改子分类信息
     * @apiGroup ProductType
     * @apiParam {int} id
     * @apiParam {int} materialId
     * @apiParam {String} productCode
    ...
    /**
     * @api {post} /product/sort/type/delete 删除子分类
     * @apiGroup ProductType
    ...
    /**
     * @api {get} /product/sort/type/list 按页获取所有子分类
     * @apiGroup ProductType
